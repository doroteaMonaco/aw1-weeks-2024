...
function AnswerTable (props) {
  ...
  return (
    <Table striped>
      ...
      <tbody>
        { sortedAnswers.map((ans) => <AnswerRow answer={ans} key={ans.id} voteUp={props.voteUp} deleteAnswer={props.deleteAnswer}/>) }
      </tbody>
    </Table>
  );
}
...
function AnswerRow(props) {
  return(
    <tr>
      ...
      <AnswerAction answer={props.answer} voteUp={props.voteUp}   deleteAnswer={props.deleteAnswer}/>
    </tr>
  );
}
...
function AnswerAction(props) {
  return(
    <td>
      ...
      <Button variant='danger' onClick={() => {props.deleteAnswer(props.answer.id)}}><i className='bi bi-trash'></i></Button>
    </td>
  );
}
